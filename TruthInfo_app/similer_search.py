...
combined_content = f"{question} {reference}"
...
if st.button("Submit"):
    ...
    query_vector = model.encode(combined_content)
    ...
    if not results["matches"]:
        ...
        for idx, doc_id in enumerate(document_ids):
            ...
            'messages': [
                ...
                # {"role": "system", "content": "Answer the users QUESTION using the DOCUMENTS. Keep your answer ground in the facts of the DOCUMENT. If the DOCUMENT doesn’t contain the facts to answer the QUESTION return {NONE}. if Topic is not related to provided content, then say 'Query is not related to topic. ' "},
        ...
        # print(response)
            if response.status_code == 200:
                ...
                insert_qa(question, text_data, document_ids)
    ...
    compute_similarities(ans, text_data)
